    ...
    <Card className='w-full max-w-[650px]'>
      ...
      <CardContent>
        <div className='grid w-full items-center gap-4 text-sm'>
          ...
          />
          {decodeURIComponent(username) !== session.user.username && (
            <Badge className='w-max'>{`${decodeURIComponent(username)} shared the task with you 🤝`}</Badge>
          )}
